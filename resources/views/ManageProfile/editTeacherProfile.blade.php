    ...
    <div class="container px-4 pb-4">
        ...
        <form method="post" action="{{ route('profile.update') }}">
            ...
            <div class="card text-bg-light shadow border-0 my-3 mb-5" id="profile">
                <div class="card-body">
                    <p class="h6 fw-bold">ACCOUNT INFORMATION</p>
        ...
        <!-- Update Information -->
        <form action="{{ route('profile.teacherUpdate', $teacher->id) }}" method="post">
            @csrf
            @method('put')

            <div class="card text-bg-light shadow border-0 my-3 mb-5" id="profile">
                <div class="card-body">
                    <p class="h6 fw-bold">TEACHER INFORMATION</p>

                    <div class="row pt-3 justify-content-start">
                        <div class="mb-3 col-4">
                            <label for="kafaName" class="form-label fw-semibold">Kafa Name</label>
                            <input type="text" class="form-control" name="kafaName" id="kafaName"
                                placeholder="Kafa Name" value="{{ old('kafaName', $teacher->kafaName) }}" />
                            <x-input-error class="mt-2" :messages="$errors->get('kafaName')" />
                        </div>
                        ...
                        <div class="mb-3 col-4">
                            ...
                            <input type="text" class="form-control" name="phoneNum" id="phoneNum"
                                placeholder="Phone Number" value="{{ old('phoneNum', $teacher->phoneNum) }}" />
                    ...
                    <div class="row pt-3 justify-content-start">
                        <div class="mb-3 col-4">
                            ...
                            <select class="form-control" name="gender" id="gender">
                                <option value="" disabled
                                    {{ old('gender', $teacher->gender) === null ? 'selected' : '' }}>Select Gender</option>
                        ...
                        <div class="mb-3 col-4">
                            ...
                            <select class="form-control" name="race" id="race">
                                ...
                                <option value="Malays" {{ old('race', $teacher->race) == 'Malays' ? 'selected' : '' }}>Malays</option>
                                <option value="Indians" {{ old('race', $teacher->race) == 'Indians' ? 'selected' : '' }}>Indians</option>
